...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{images/time\_distribution.png}
  \caption{Breakdown of the distribution of execution time across different number of threads usage}
  \Description{Breakdown of the distribution of execution time across different number of thread usage}
  \label{fig1}
\end{figure}
